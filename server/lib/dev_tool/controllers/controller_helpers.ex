defmodule DevTool.ControllerHelpers do
  @moduledoc """
    DevTool.ControllerHelpers give some helper functions to assign error/data to the conn and send the response to the view.
  """
